...
int main(int argc, char *argv[])
{
    ...
    for (int i = 0; i < tam; i++)
    {
        ...
        // if((picDesejado.r - picParecido.g)>= -50 && (picDesejado.r - picParecido.g)<=10){
        // pic[SAIDA].img[i].r = pic[SAIDA].img[i].r - 50 ;
        // pic[SAIDA].img[i].g = pic[SAIDA].img[i].g - 50 ;
        //  pic[SAIDA].img[i].b = pic[SAIDA].img[i].b - 50 ;
    }
